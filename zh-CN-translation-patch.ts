/**
 * OpenClaw Control UI 中文翻译补充文件
 * 此文件包含建议添加到 zh-CN.ts 的翻译
 * 
 * 使用说明：
 * 1. 将此文件内容合并到 packages/control-ui/src/i18n/zh-CN.ts
 * 2. 确保保持 TypeScript 语法正确
 * 3. 运行 npm run build 测试编译
 */
